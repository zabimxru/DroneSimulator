...
public class TestData {
	...
	public static final Drone[] DRONE_DATA = {
			new Drone(71, new DroneType(1, "katze","lol",2,2,2,2,2), createDateFromString("28.01.2024"), "MIAU-1234", 45, "MEKMEK"),
			new Drone(72, new DroneType(2, "hund","lol",1,1,1,1,1), createDateFromString("29.01.2024"), "WUFF-1234", 50, "EKEK")
	};
	
	public static final DroneDynamic[] DRONEDYNAMIC_DATA = {
			new DroneDynamic(createDateFromString("28.01.2024") ,"Katze",150.00, 1.5, 1.5,
